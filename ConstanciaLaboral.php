...
if (!mysqli_stmt_prepare($stmt, $sql)) {
    ...
    $result = mysqli_stmt_get_result($stmt);
        ...
        if(mysqli_num_rows($result)>0){
            ...
            $pdf->Ln(20);
            $pdf->Cell(0,15,utf8_decode('Asunto: Constancia Laboral'));
            $pdf->Ln(20);
            ...
            $pdf->Ln(5);
            $pdf->Cell(0,15,utf8_decode('presto sus servicios desde el:  '.$followresult['fecha_ingreso']));
            $pdf->Ln(5);
            $pdf->Cell(0,15,utf8_decode('hasta el:  '.$followresult['fecha_ingreso']));
            $pdf->Ln(5);
            $pdf->Cell(0,15,utf8_decode('en el cargo de '.$followresult['cargo']));
            $pdf->Ln(5);
            $pdf->Cell(0,15,utf8_decode('Durante su tiempo en la compañia el desempeño de sus labores fue satisfactorio.'));
            $pdf->Ln(5);
