...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
  ...
  <div class="container">
    <div class="form-area">
      <form role="form" method="POST">
        <br>
        <h3 style="margin-bottom: 25px; text-align: center;"><b>Registro de entrada y salida</b></h3>
        <br>
        <br>
        <br>
            ...
            <div class="form-group">
              ...
              <select name="id_turno" id="id_turno" class="form-control"  required>
                ...
                while ($row = mysqli_fetch_array($result)) {
                  echo '<option value="' . $row['id_turno'] . '">' . $row['id_turno'] . " " . $row['nombres'] . " " . $row['apellidos'] . '</option>';
                }
                ?>
              </select>
            </div>
        ...
        <center><b><input type="submit" name="btnRegistrar" class="btn btn-primary" value="Registrar Entrada"></b>

          <a href="BuscarEntrada.php"><input type="button" name="btnBuscar" class="btn btn-primary" value="Consultar Ingresos"></a>
  ...
  if (isset($_REQUEST['btnRegistrar'])) {
    ...
    $consulta = "UPDATE planilla_turno SET fecha_inicio_registrada='$FECHA_INICIO', fecha_fin_registrada='$FECHA_FIN', hora_inicio_registrada='$HORA_INICIO'
    ...
    if ($resultado) {
      ...
      echo '<Strong>---------Registro completo!</Strong>Se ha registrado su entrada correctamente.';
      echo '</div>';
    } else {
      echo '<div class="alert alert-danger">';
      echo '<Strong> No se ha registrado su entrada..</Strong>';
      echo '</div>';
    }
