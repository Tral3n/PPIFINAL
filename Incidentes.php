...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="container">
        <form role="form" method="POST">
            <div class="row justify-content-center">
                ...
                <br>
                <center>
                    <h4><b>Registro de Incidentes</b></h4>
                </center>
                <br>
                    ...
                    <div class="session-box">
                        <div class="media-body">
                            <div class="media align-items-center sm-avatar">
                                <div class="form-group">
                                    ...
                                    <select name="id_turno" id="id_turno" class="form-control" required>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo '<option value="' . $row['id_turno'] . '">' . $row['id_turno'] . " " . $row['nombres'] . " " . $row['apellidos'] . " " . $row['tipo_turno'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <br>
                                    <label for="formGroupExampleInput" class="form-label"><b>ID Incidente</b></label>
                                    <select name="id_incidente" id="id_incidente" class="form-control" required>
                                        <option value="">Seleccione...</option>
                                        <?php
                                        include "Conexion/Conexion.php";
                                        $conexion = mysqli_connect($db_host, $db_usuario, $db_pw, $db_nombre);
                                        ...
                                        $result = mysqli_query($conexion, $query);
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo '<option value="' . $row['id_incidente'] . '">' . $row['id_tipo_incidente'] . " " . $row['descripcion'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                        ...
                        <div class="media-body">
                            <div class="media align-items-center sm-avatar">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fechai" name="fechai" required value="<?php echo date("Y-m-d"); ?>">
                                </div>
                                <br>

                                <div class="form-group">
                                    <label for="formGroupExampleInput" class="form-label"><b>Descripcion</b></label>
                                    <textarea type="text" class="form-control" id="descripcion" name="descripcion" value="" style="height: 134px;" placeholder="Descripcion" required></textarea>
                                </div>
                                <br>
                            </div>
                        </div>
            ...
            <br>
            <br>
            <center><b><input type="submit" name="btnRegistrar" class="btn btn-primary" value="Registrar Incidente"></b>

                <a href="BuscarIncidente.php"><input type="button" name="btnBuscar" class="btn btn-primary" value="Consultar Incidentes"></a>
    ...
    if (isset($_REQUEST['btnRegistrar'])) {
        ...
        $consulta = "INSERT INTO incidentes_por_turno (id_incidente_por_turno, id_incidente, id_turno, fecha_incidente, descripcion)
                     VALUES('','$ID_INCIDENTE','$ID_TURNO','$FECHAI','$DESCRIPCION')";
        ...
        if ($resultado) {
            ...
            echo '<Strong> No se ha registrado el incidente..</Strong>';
            echo '</div>';
        }
