  ...
  <br>
    ...
    ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Error!</strong> Escoja un turno valido para editar.
    ...
    ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Modificacion exitosa</strong> Turno actualizado.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php
    }
    ...
    ?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Eliminacion exitosa</strong> El turno ha sido eliminado con exito.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php
    }
    ...
    <div class="container mt-5">
        ...
        AND   pt.id_tipo_turno = tt.id_tipo_turno;";
            ...
            echo '<table class="table table-dark table-striped align-left">';
                    ...
                    echo '<th scope="col">Fecha Inicio Programada</th>';
                    echo '<th scope="col">Fecha Fin Programada</th>';
                    echo '<th scope="col">Hora Inicio Programada</th>';
                    echo '<th scope="col">Hora Fin Programada</th>';
                    echo '<th scope="col">Novedad</th>';
                    ...
                    while ($row = mysqli_fetch_array($resultado)) {
                        ...
                        echo '<td>' . $row['fecha_inicio_programada'] . '</td>';
                        echo '<td>' . $row['fecha_fin_programada'] . '</td>';
                        echo '<td>' . $row['hora_inicio_programada'] . '</td>';
                        echo '<td>' . $row['hora_fin_programada'] . '</td>';
                        echo '<td>' . $row['novedad'] . '</td>';
                        echo '<td>' . '<a onclick="return confirm('."'Estas seguro de editar?'".');"class="text-success" href="EditarTurno.php?codigo=' . $row['id_turno'] . '"><i class="bi bi-pencil-square"></i></a>' . '</td>';
                        echo '<td>' . '<a onclick="return confirm('."'Estas seguro de eliminar?'".');" class="text-danger" href="EliminarTurno.php?codigo=' . $row['id_turno'] . '"><i class="bi bi-trash3"></i></i></a>' . '</td>';
                        echo '</tr>';
                        echo '</tbody>';
                    }
                    echo '</table>';
