...
<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    $consulta = "SELECT * FROM incidentes_por_turno WHERE id_incidente_por_turno='$codigo'";
    $resultado = mysqli_query($conexion, $consulta);

    while ($row = mysqli_fetch_array($resultado)) {
        $codigo = $row['id_incidente_por_turno'];
    ...
    <div class="container">
        <div class="form-area">
            <form class="p-4" method="POST" action="editarIncidenteProceso.php">
                <br>
                <h2 style="margin-bottom: 25px; text-align: center;"><b>Editar Incidente</b></h2>
                <br>
                <br>
                <br>
                <div class="row justify-content-center">
                    <div class="col-4">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_incidente" id="id_incidente" class="form-control" value="<?php echo $id_incidente;  ?>" required>
                                <?php
                                include "Conexion/Conexion.php";
                                $conexion = mysqli_connect($db_host, $db_usuario, $db_pw, $db_nombre);
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fechai" name="fechai" required value="<?php echo $fecha_incidente;  ?>">
                        </div>
                        <br>

                        <div class="form-group">
                            <label for="formGroupExampleInput" class="form-label"><b>Descripcion</b></label>
                            <textarea type="text" class="form-control" id="descripcion" name="descripcion"  style="height: 134px;"  value="<?php echo $descripcion;  ?>" required> <?php echo $descripcion;  ?></textarea>
                        </div>
                        <br>
                    </div>
                    <center><b><input type="hidden" name="codigo" value="<?php echo $codigo  ?>">
                            ...
                            <a href="BuscarIncidente.php"><input type="button" name="btnVolver" class="btn btn-primary" value="Volver"></a>
                        </b>
                    </center>
                </div>
            </form>
